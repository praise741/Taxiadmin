                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6 m-b-0">
                                                                <div class="form-group mb-3">
                                                                    <?php 
                                                                        $tab_vehicule[] = array();
                                                                        $tab_vehicule = getTypeVehicule();
                                                                    ?>
                                                                    <label class="mr-sm-2" for="designation">Type of vehicle</label>
                                                                    <select class="form-control " id="exampleFormControlSelect1" name="type_vehicule" required>
                                                                        <?php
                                                            ...
                                                            <div class="col-md-6 m-b-0">
                                                                <div class="form-group mb-3">
                                                                    ...
                                                                    <input type="number" class="form-control " placeholder="" name="prix_vehicule" id="prix_vehicule" required> 
                                                                    <div class="invalid-feedback">
                                                            ...
                                                            <div class="col-md-6 m-b-0">
                                                                <div class="form-group mb-3">
                                                                    ...
                                                                    <input type="number" class="form-control " placeholder="" name="nb_place_vehicule" id="nb_place_vehicule" required> 
                                                                    <div class="invalid-feedback">
                                                                        Désolé, entrez l'intitulé de la catégorie de devis
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="col-md-6 m-b-0">
                                                                <div class="form-group mb-3">
                                                                    ...
                                                                    <select class="form-control " id="exampleFormControlSelect1" name="statut_vehicule" required>
                                                            ...
                                                            <div class="col-md-6 m-b-0">
                                                                <div class="form-group mb-3">
                                                                    ...
                                                                    <input type="number" class="form-control " placeholder="" name="nombre_vehicule" id="nombre_vehicule" required> 
                                                                    <div class="invalid-feedback">
                                                                        Désolé, entrez l'intitulé de la catégorie de devis
                                                                    </div>
                                                                </div>
                                        ...
                                        <div class="modal-content bg-gris">
                                            ...
                                            <form class="form-horizontal " action="query/action.php" method="post" enctype="multipart/form-data">
                                                <div class="modal-body">
                                                    <div class="form-group">
                                                        <div class="row">
                                                            <input type="hidden" name="id_vehicule_mod" id="id_vehicule_mod" value="<?php echo $id_user; ?>">
                                                            <div class="col-md-6 m-b-0">
                                                                <div class="form-group mb-3">
                                                                    <?php 
                                                                        $tab_vehicule[] = array();
                                                                    ...
                                                                    ?>
                                                                    <label class="mr-sm-2" for="designation">Type of vehicle</label>
                                                                    <select class="form-control " id="type_vehicule_mod" name="type_vehicule_mod" required>
                                                                        <?php
                                                                            for($i=0; $i<count($tab_vehicule); $i++){
                                                                                echo '<option value="'.$tab_vehicule[$i]['id'].'"'; if($tab_vehicule[$i]['id'] != "Administrateur"){echo "selected";} echo '>'.$tab_vehicule[$i]['libelle'].'</option>';
                                                                            }
                                                            ...
                                                            <div class="col-md-6 m-b-0">
                                                                <div class="form-group mb-3">
                                                                    <label class="mr-sm-2" for="designation">Rental price</label>
                                                                    <input type="number" class="form-control " placeholder="" name="prix_vehicule_mod" id="prix_vehicule_mod" required> 
                                                                    <div class="invalid-feedback">
                                                                        Désolé, entrez l'intitulé de la catégorie de devis
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="col-md-6 m-b-0">
                                                                <div class="form-group mb-3">
                                                                    <label class="mr-sm-2" for="designation">Number of places</label>
                                                                    <input type="number" class="form-control " placeholder="" name="nb_place_vehicule_mod" id="nb_place_vehicule_mod" required> 
                                                                    <div class="invalid-feedback">
                                                                        Désolé, entrez l'intitulé de la catégorie de devis
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="col-md-6 m-b-0">
                                                                <div class="form-group mb-3">
                                                                    <label class="mr-sm-2" for="designation">Status</label>
                                                                    <select class="form-control " id="statut_vehicule_mod" name="statut_vehicule_mod" required>
                                                                        <option value="yes">Yes</option>
                                                                        <option value="no">No</option>
                                                                    </select>
                                                                    <div class="invalid-feedback">
                                                            ...
                                                            <div class="col-md-6 m-b-0">
                                                                <div class="form-group mb-3">
                                                                    ...
                                                                    <input type="number" class="form-control " placeholder="" name="nombre_vehicule_mod" id="nombre_vehicule_mod" required> 
                                                                    <div class="invalid-feedback">
                                                                        Désolé, entrez l'intitulé de la catégorie de devis
                                                                    </div>
                                                                </div>
                                            ...
                                            <?php
                                                for($i=0; $i<count($tab_vehicule); $i++){
                                                    echo'
                                                        <tr>
                                                            <td>'.($i+1).'</td>
                                                            <td><img src="assets/images/vehicule/'.$tab_vehicule[$i]['image'].'"width="100%"/></td>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href="query/action.php?id_vehicule='.$tab_vehicule[$i]['id'].'" class="btn btn-danger btn-sm" data-toggle="tooltip" data-original-title="Delete"> <i class="fa fa-trash"></i> </a>
                                                                <a href="query/action.php?id_vehicule_activer='.$tab_vehicule[$i]['id'].'" class="btn btn-success btn-sm" data-toggle="tooltip" data-original-title="Activate"> <i class="fa fa-check"></i> </a>
                                                                <a href="query/action.php?id_vehicule_desactiver='.$tab_vehicule[$i]['id'].'" class="btn btn-inverse btn-sm" data-toggle="tooltip" data-original-title="Deactivate"> <i class="fa fa-close"></i> </a>
                                                            </td>
                                                        </tr>
                                                    ';
                                                }
        ...
        function modVehicule(id_vehicule){
            $.ajax({
                ...
                success: function (data) {
                    $("#id_vehicule_mod").empty();
                    $("#prix_vehicule_mod").empty();
                    $("#nb_place_vehicule_mod").empty();
                    $("#nombre_vehicule_mod").empty();

                    var data_parse = JSON.parse(data);

                    $("#id_vehicule_mod").val(data_parse[0].id);
                    $("#statut_vehicule_mod").val(data_parse[0].statut).change();
                    $("#prix_vehicule_mod").val(data_parse[0].prix);
                    $("#nb_place_vehicule_mod").val(data_parse[0].nb_place);
                    $("#nombre_vehicule_mod").val(data_parse[0].nombre);
                    $("#type_vehicule_mod").val(data_parse[0].id_type_vehicule).change();
                }
            });
        }
    </script>
