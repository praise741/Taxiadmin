                                                ...
                                                for($i=0; $i<count($tab_requete); $i++){
                                                    ...
                                                    echo'
                                                        <tr>
                                                            ...
                                                            <td>'.$cout.' CFA</td>
                                                            <td><span class="';
                                                            if($tab_requete[$i]['statut'] == "en cours"){echo 'badge badge-warning">'.$tab_requete[$i]['statut'].'</span></td>';}
                                                            else if($tab_requete[$i]['statut'] == "accepter"){echo 'badge badge-success">'.$tab_requete[$i]['statut'].'</span></td>';}
                                                            echo '<td><span class="';
                                                            if($tab_requete[$i]['statut_course'] == "en cours"){echo "badge badge-warning";}
                                                            else if($tab_requete[$i]['statut_course'] == "accepter"){echo "badge badge-success";}
                                                            else if($tab_requete[$i]['statut_course'] == "clôturer"){echo "badge badge-dark";}
                                                            else{echo "badge badge-dark";}
                                                            echo '">'.$tab_requete[$i]['statut_course'].'</span></td>';
                                                            echo '<td>'.$tab_requete[$i]['creer'].'</td>
