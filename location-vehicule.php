                                                ...
                                                for($i=0; $i<count($tab_location); $i++){
                                                    echo'
                                                        <tr>
                                                            ...
                                                            <td><span class="'; if($tab_location[$i]['statut'] == "accepter"){echo "badge badge-success";}
                                                            else if($tab_location[$i]['statut'] == "en cours"){echo "badge badge-warning";}
                                                            else if($tab_location[$i]['statut'] == "refuser"){echo "badge badge-danger";}
                                                            else{echo "badge badge-inverse";}
                                                            echo '"'; if($tab_location[$i]['statut'] == "clôturer"){echo 'style="color:#fff;"';} echo '>'.$tab_location[$i]['statut'].'</span></td>
